...
public interface UserService {
    ...
    User deleteUser(String uname);
    User updateUser(String uname, User updated);
    boolean updateUserStatus(String uname, boolean validation);
    static String generateCommonLangPassword(){
